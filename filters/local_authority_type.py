...
local_authority_type_csv = os.environ.get("local_authority_type_csv", "https://raw.githubusercontent.com/digital-land/organisation-collection/master/collection/register/local-authority-type.csv")
